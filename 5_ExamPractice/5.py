...
class SmartSecuritySystem(SecurityCamera,AlarmSystem,AccessControl):
    ...
    def __init__(self,camera_id,resolution,alarm_type,alarm_status,access_type,authorized_users):
        SecurityCamera.__init__(self,camera_id,resolution)
        AlarmSystem.__init__(self,alarm_status,alarm_type)
        AccessControl.__init__(self,access_type,authorized_users)

obj  = SmartSecuritySystem(12,"1440p","Fire","Morning","Personnel","Guards")
obj.camera_info()
obj.alarm_info()
obj.access_info()
